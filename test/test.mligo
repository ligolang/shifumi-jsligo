...
let test =
    ...
    let _session_0_complete_1_round_paper_stone = 
        ...
        let count (acc, _i: nat * SHIFUMI.Storage.Session.player_action) : nat = acc + 1n in
        ...
        let count_ (acc, _i: nat * SHIFUMI.Storage.Session.decoded_player_action) : nat = acc + 1n in
