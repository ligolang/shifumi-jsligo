...
let test =
    ...
    let orig = Test.originate (contract_of SHIFUMI) init_storage 0tez in
    let s_init = Test.get_storage orig.addr in
    ...
    let _session_0_complete_1_round_paper_stone =
        ...
        let _ = Test.transfer_exn orig.addr (CreateSession(session_args)) 0mutez in
        // verify session creation
        let session_0 : SHIFUMI.Storage.Session.t = get_session_from_storage(orig.addr, current_session_id) in
        ...
        let _ = Test.transfer_exn orig.addr (Play(play_args)) 1tez in
        ...
        let _ = Test.transfer_exn orig.addr (RevealPlay(reveal_args)) 0mutez in
        let session_0 : SHIFUMI.Storage.Session.t = get_session_from_storage(orig.addr, current_session_id) in
        let () = assert (session_0.current_round = 1n) in
        let () = assert (session_0.total_rounds = 1n) in
        let () = assert (session_0.result = Inplay) in
        ...
        let _ = Test.transfer_exn orig.addr (RevealPlay(bob_reveal_args)) 0mutez in
        let session_0 : SHIFUMI.Storage.Session.t = get_session_from_storage(orig.addr, current_session_id) in
        let session_0_decoded_round_1 : SHIFUMI.Storage.Session.decoded_player_actions = get_decoded_round_from_session(session_0, 1n) in
        let () = Test.log(session_0_decoded_round_1) in
        let count_ (acc, _: nat * SHIFUMI.Storage.Session.decoded_player_action) : nat = acc + 1n in
    ...
    let _session_1_partial_1_round_paper_stone =
        ...
        let s2 : SHIFUMI.Storage.t = Test.get_storage orig.addr in
        //let () = Test.log(s2) in
    ...
    let _session_4_partial_stopped =
        ...
        //let () = Test.log(play_args) in
        let _ = Test.transfer_exn orig.addr (StopSession(stop_args)) 0mutez in
    ...
    let _session_5_stop_session_fail_unknown_session =
        ...
        let fail_stop_session = Test.transfer orig.addr (StopSession(stop_args)) 0mutez in
    ...
    let _session_9_play_fail_unauthorized_user =
        ...
        let fail_play = Test.transfer orig.addr (Play(play_args)) 1tez in
    ...
    let _session_13_reveal_fail_unknown_session =
        ...
        let fail_reveal = Test.transfer orig.addr (RevealPlay(reveal_args)) 0mutez in
    ...
    let _session_15_reveal_fail_wrong_current_round =
        ...
        let fail_reveal = Test.transfer orig.addr (RevealPlay(bob_reveal_args)) 0mutez in
    ...
    let _session_20_reveal_fail_already_revealed =
        ...
        let _ = Test.transfer orig.addr (RevealPlay(bob_reveal_args)) 0mutez in
    ...
    in  let _session_24_stop_session_draw =
        ...
        let _ = Test.transfer_exn orig.addr (CreateSession(session_args)) 0mutez in
        // verify session creation
        let session_24 : SHIFUMI.Storage.Session.t = get_session_from_storage(orig.addr, current_session_id) in
        ...
        let () = Test.bake_until_n_cycle_end 5n in
        let stop_args : SHIFUMI.Parameter.stopsession_param = {sessionId=current_session_id} in
        let _fail_stop_session = Test.transfer orig.addr (StopSession(stop_args)) 0mutez in
        let session_24 : SHIFUMI.Storage.Session.t = get_session_from_storage(orig.addr, current_session_id) in
